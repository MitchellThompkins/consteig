...
TEST(utilities, compare_floats)
{
    ...
    static constexpr bool aCompareTest =
        approxEqual(aCompare1, aCompare2, CONSTEIG_TEST_TOLERANCE);
    ...
    static constexpr bool bCompareTest =
        approxEqual(bCompare1, bCompare2, CONSTEIG_TEST_TOLERANCE);
...
TEST(utilities, compare_floats_compare)
{
    ...
    static constexpr bool compareTest1 =
        approxEqual(compare1, compare2, 1e-6); // Design-intent: Expect true
    static constexpr bool compareTest2 =
        approxEqual(compare1, compare2, 1e-8); // Design-intent: Expect false

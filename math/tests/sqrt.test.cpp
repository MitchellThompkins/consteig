...
TEST(sqrt_function, sqrt_basic_double)
{
    ...
    static_assert(
        consteig::approxEqual(aConsteig, aStd, CONSTEIG_TEST_TOLERANCE), MSG);
    ...
    static_assert(
        consteig::approxEqual(bConsteig, bStd, CONSTEIG_TEST_TOLERANCE), MSG);
...
TEST(sqrt_function, sqrt_long_double)
{
    ...
    static_assert(consteig::approxEqual(static_cast<double>(eConsteig),
                                        242.0377756673646,
...
TEST(sqrt_function, sqrt_float)
{
    ...
    static_assert(consteig::approxEqual(fConsteig, 2.0585189f,
...
TEST(sqrt_function, csqrt_positive_float)
{
    ...
    static_assert(consteig::approxEqual(gConsteig.real, 4.711687595f,
                                        CONSTEIG_FLOAT_TEST_TOLERANCE),
                  MSG);
...
TEST(sqrt_function, csqrt_negative_float)
{
    ...
    static_assert(consteig::approxEqual(gConsteig.imag, 4.711687595f,
                                        CONSTEIG_FLOAT_TEST_TOLERANCE),
                  MSG);
...
TEST(sqrt_function, csqrt_positive_double)
{
    ...
    static_assert(consteig::approxEqual(gConsteig.real, 4.711687595674061,
                                        CONSTEIG_TEST_TOLERANCE),
                  MSG);
...
TEST(sqrt_function, csqrt_negative_double)
{
    ...
    static_assert(consteig::approxEqual(gConsteig.imag, 4.711687595674061,
                                        CONSTEIG_TEST_TOLERANCE),
                  MSG);
...
TEST(sqrt_function, sqrt_large)
{
    ...
    static_assert(consteig::approxEqual(lRes, 1e10, LARGE_VAL_TOL), MSG);

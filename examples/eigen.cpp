...
int main() {
    ...
    static constexpr consteig::Matrix<double, s, s> mat{{{{-4.4529e-01, 4.9063e+00, -8.7871e-01, 6.3036e+00},
    ...
    static constexpr consteig::Matrix<consteig::Complex<double>, s, 1> testEigVals{consteig::eigvals(mat)};

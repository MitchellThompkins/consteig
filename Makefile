...
help:
	...
	@echo 'TARGETS:'
	@echo
	@echo 'build.gcc / build.clang'
	@echo '    build with a specific native compiler'
	@echo
	@echo 'test.gcc / test.clang'
	@echo '    build and run tests with a specific native compiler'
	@echo

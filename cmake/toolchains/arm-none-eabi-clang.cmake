...
set(ARM_GCC_VER "15.2.1")
set(ARM_CXX_INC "${ARM_GCC_ROOT}/arm-none-eabi/include/c++/${ARM_GCC_VER}")
set(ARM_C_INC "${ARM_GCC_ROOT}/arm-none-eabi/include")
set(ARM_GCC_INC "${ARM_GCC_ROOT}/lib/gcc/arm-none-eabi/${ARM_GCC_VER}/include")
